...
export const homeStatic: RequiredDataFromCollectionSlug<'pages'> = {
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                mode: 'normal',
                style: '',
                text: ' The cure for the common cover, serving Cold Fusion Refreshments since day one.',
                version: 1,
              },
            ],
            direction: 'ltr',
  ...
  layout: [
    ...
    },
    {
      ...
      videoId: 'ysz5S6PUM-U',
      caption:
        'Drop a live clip, session recording, or video here so new visitors can feel the cold shock therapy for themselves.',
    },
    {
      blockType: 'eventsPreview',
      heading: 'Upcoming Events',
      description: 'Live dates, local appearances, and upcoming chances to hear The Coldies.',
      status: 'upcoming',
      limit: 3,
    },
    {
              ...
              children: [
                {
                  ...
                  mode: 'normal',
                  style: '',
                  text: 'Field dispatches from the expedition — show recaps, new finds from the cooler, and the latest from the glacio-acoustic lab.',
                  version: 1,
                },
              ],
              direction: 'ltr',
